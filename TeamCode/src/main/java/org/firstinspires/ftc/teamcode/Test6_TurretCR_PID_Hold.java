...
@Config
@TeleOp(name = "Test6_TurretCR_PID_Hold", group = "Test")
public class Test6_TurretCR_PID_Hold extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        turretServo = hardwareMap.get(Servo.class, "turretTurnRight"); // Continuous
        ...
        telemetry.addLine("Turret CR PID Hold Initialized. Press Start");
        telemetry.update();
        waitForStart();
        limelight.start();
        ...
        while (opModeIsActive()) {
            ...
            turretLogicalPos += servoPower * 300 * dt; // 300 deg/sec full power estimate
